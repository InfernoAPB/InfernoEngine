...
goog.exportSymbol('proto.com.inferno.protos.UserProfileUpdateResponse', null, global);
goog.exportSymbol('proto.com.inferno.protos.UserUpdateResponse', null, global);
 ...
 * @return {string}
 */
proto.com.inferno.protos.User.prototype.getUserId = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 6, ""));
};


/** @param {string} value */
proto.com.inferno.protos.User.prototype.setUserId = function(value) {
 ...
 * @return {string}
 */
proto.com.inferno.protos.UserProfile.prototype.getUserId = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 11, ""));
};


/** @param {string} value */
proto.com.inferno.protos.UserProfile.prototype.setUserId = function(value) {
 ...
 * @constructor
 */
proto.com.inferno.protos.UserUpdateResponse = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.com.inferno.protos.UserUpdateResponse, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  proto.com.inferno.protos.UserUpdateResponse.displayName = 'proto.com.inferno.protos.UserUpdateResponse';
}
 ...
 * @return {!Object}
 */
proto.com.inferno.protos.UserUpdateResponse.prototype.toObject = function(opt_includeInstance) {
  return proto.com.inferno.protos.UserUpdateResponse.toObject(opt_includeInstance, this);
};
 ...
 *     instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.com.inferno.protos.UserUpdateResponse} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.com.inferno.protos.UserUpdateResponse.toObject = function(includeInstance, msg) {
  var f, obj = {
    name: jspb.Message.getFieldWithDefault(msg, 1, ""),
    fbId: jspb.Message.getFieldWithDefault(msg, 2, ""),
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.com.inferno.protos.UserUpdateResponse}
 */
proto.com.inferno.protos.UserUpdateResponse.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.com.inferno.protos.UserUpdateResponse;
  return proto.com.inferno.protos.UserUpdateResponse.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.com.inferno.protos.UserUpdateResponse} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.com.inferno.protos.UserUpdateResponse}
 */
proto.com.inferno.protos.UserUpdateResponse.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.com.inferno.protos.UserUpdateResponse.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.com.inferno.protos.UserUpdateResponse.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.com.inferno.protos.UserUpdateResponse} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.com.inferno.protos.UserUpdateResponse.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getName();
  if (f.length > 0) {
    writer.writeString(
 ...
 * @return {string}
 */
proto.com.inferno.protos.UserUpdateResponse.prototype.getName = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 1, ""));
};


/** @param {string} value */
proto.com.inferno.protos.UserUpdateResponse.prototype.setName = function(value) {
  jspb.Message.setProto3StringField(this, 1, value);
};
 ...
 * @return {string}
 */
proto.com.inferno.protos.UserUpdateResponse.prototype.getFbId = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 2, ""));
};


/** @param {string} value */
proto.com.inferno.protos.UserUpdateResponse.prototype.setFbId = function(value) {
  jspb.Message.setProto3StringField(this, 2, value);
};
 ...
 * @return {string}
 */
proto.com.inferno.protos.UserUpdateResponse.prototype.getUserId = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 3, ""));
};


/** @param {string} value */
proto.com.inferno.protos.UserUpdateResponse.prototype.setUserId = function(value) {
  jspb.Message.setProto3StringField(this, 3, value);
};
 ...
 * @return {string}
 */
proto.com.inferno.protos.UserUpdateResponse.prototype.getPlatform = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 4, ""));
};


/** @param {string} value */
proto.com.inferno.protos.UserUpdateResponse.prototype.setPlatform = function(value) {
  jspb.Message.setProto3StringField(this, 4, value);
};
 ...
 * @constructor
 */
proto.com.inferno.protos.UserProfileUpdateResponse = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.com.inferno.protos.UserProfileUpdateResponse, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  proto.com.inferno.protos.UserProfileUpdateResponse.displayName = 'proto.com.inferno.protos.UserProfileUpdateResponse';
}
 ...
 * @return {!Object}
 */
proto.com.inferno.protos.UserProfileUpdateResponse.prototype.toObject = function(opt_includeInstance) {
  return proto.com.inferno.protos.UserProfileUpdateResponse.toObject(opt_includeInstance, this);
};
 ...
 *     instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.com.inferno.protos.UserProfileUpdateResponse} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.com.inferno.protos.UserProfileUpdateResponse.toObject = function(includeInstance, msg) {
  var f, obj = {
    updatedprofile: (f = msg.getUpdatedprofile()) && proto.com.inferno.protos.UserProfile.toObject(includeInstance, f)
  };
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.com.inferno.protos.UserProfileUpdateResponse}
 */
proto.com.inferno.protos.UserProfileUpdateResponse.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.com.inferno.protos.UserProfileUpdateResponse;
  return proto.com.inferno.protos.UserProfileUpdateResponse.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.com.inferno.protos.UserProfileUpdateResponse} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.com.inferno.protos.UserProfileUpdateResponse}
 */
proto.com.inferno.protos.UserProfileUpdateResponse.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
    ...
    switch (field) {
    case 1:
      var value = new proto.com.inferno.protos.UserProfile;
      reader.readMessage(value,proto.com.inferno.protos.UserProfile.deserializeBinaryFromReader);
      msg.setUpdatedprofile(value);
      break;
    default:
      reader.skipField();
      break;
 ...
 * @return {!Uint8Array}
 */
proto.com.inferno.protos.UserProfileUpdateResponse.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.com.inferno.protos.UserProfileUpdateResponse.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.com.inferno.protos.UserProfileUpdateResponse} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.com.inferno.protos.UserProfileUpdateResponse.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getUpdatedprofile();
  if (f != null) {
    writer.writeMessage(
      1,
      f,
      proto.com.inferno.protos.UserProfile.serializeBinaryToWriter
    );
  }
};
...
/**
 * optional UserProfile updatedProfile = 1;
 * @return {?proto.com.inferno.protos.UserProfile}
 */
proto.com.inferno.protos.UserProfileUpdateResponse.prototype.getUpdatedprofile = function() {
  return /** @type{?proto.com.inferno.protos.UserProfile} */ (
    jspb.Message.getWrapperField(this, proto.com.inferno.protos.UserProfile, 1));
};


/** @param {?proto.com.inferno.protos.UserProfile|undefined} value */
proto.com.inferno.protos.UserProfileUpdateResponse.prototype.setUpdatedprofile = function(value) {
  jspb.Message.setWrapperField(this, 1, value);
};


proto.com.inferno.protos.UserProfileUpdateResponse.prototype.clearUpdatedprofile = function() {
  this.setUpdatedprofile(undefined);
};
 ...
 * @return {!boolean}
 */
proto.com.inferno.protos.UserProfileUpdateResponse.prototype.hasUpdatedprofile = function() {
